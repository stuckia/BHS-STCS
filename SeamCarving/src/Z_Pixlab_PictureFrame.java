 ...
 * @author Barb Ericson 
 */
public class Z_Pixlab_PictureFrame
{
   ...
   * picture frame
   */
  public Z_Pixlab_PictureFrame(Z_Pixlab_DigitalPicture picture)
  {
   ...
   */
  public void setPicture(Z_Pixlab_Picture picture)
  {
    this.picture = picture;
